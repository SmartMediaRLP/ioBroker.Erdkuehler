...
function startAdapter(options)
{
	...
	adapter.on('ready', function()
	{
		...
		library.set({node: 'move_up', role: 'button', type: 'boolean', description: 'Move Erdkuehler up'});
		library.set({node: 'move_down', role: 'button', type: 'boolean', description: 'Move Erdkuehler down'});
